...
on a 5-point Likart scale, with values ranging from 1 - ``I never ask myself 
this question," to 5 - ``I often ask myself this question."
...
The codes we created (Table \ref{Table:SurveyCoding}) included $find$ and 
$compare$ reachability questions \cite{latoza-2010-reach}, general program 
comprehension questions across control-flow paths, as well as questions that we
deemed as being invalid to our study due to their imperfect mapping to 
...
and 9 were asked most frequently
