...
Figure \ref{fig:SurveyResults} presents the responses provided by 
\numFinished{} software developers to 9 questions that were contextualized
with a software development scenario.
The questions and scenarios are detailed in full in Appendix 
\ref{sec:DevelopmentQuestions}.
