...
\newcommand{\numStarted}{108}
\newcommand{\numFinished}{72}
\newcommand{\writeCodeDaily}{60}
\newcommand{\writeCodeTwoDays}{11}
...
% YoE as percentages
\newcommand{\zeroToTwo}{25}
\newcommand{\twoToFive}{31}
\newcommand{\fiveToSeven}{14}
\newcommand{\sevenPlus}{31}
...
From these sources, we drafted a set of 9 questions that we hypothesized 
...
\par Each question was assigned a tag that represented the category of
