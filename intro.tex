...
\par Tools such as \emph{Whyline} can help developers reason about
...
Whyline requires developers to run a program to collect an execution history.
...
Using Whyline, developers are able to inspect a preset collection of question-
and-answer pairs about the state of their programs that they may use to help
answer reachability questions.

% TODO: maybe include a figure of the Whyline interface, talk a little bit
%       about how it looks, and how it's different from what developers
%       usually see.
...
% TODO: leave in or leave out, flowery af.
