...
However, it introduces the question of how best to display program information 
in a useful \emph{and} usable manner; creating a separate environment that
may present information in an unfamiliar context may have unintended effects
on a developer's cognitive load.
