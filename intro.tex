...
% TODO: check back here to see if we end up building a plugin or an actual
%       extension of IntelliJ.
...
We evaluated the performance of \toolname{} by conducting a user study
