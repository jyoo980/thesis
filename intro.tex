...
\newcommand{\toolname}{ReachMaster 420}
\newcommand{\userstudynum}{69}
...
\cite{reps-1983-context} enable developers to quickly work in systems they
...
\par Researchers have investigated tools that help developers answer 
reachability questions.
Tools such as \emph{Whyline} can help developers reason about
...
However, Whyline requires a program execution trace to generate the information 
needed for a retrospective debugging session. It also limits developers to a
preset collection of questions-and-answers that they are able to
query.
...
developers ask in practice by analyzing the results of a survey distributed
...
\begin{itemize}
  \item Provides empirical evidence in support of the type and frequency of
        ...
        \cite{latoza-2010-reach}.
  \item Introduces \toolname, an extension of the IntelliJ IDEA IDE that uses
        lightweight program analysis methods to enable developers to
        effectively answer reachability questions that occur in high frequency.
\end{itemize}

A study of the questions that software developers ask in practice, tools that
support developer questions, and \emph{how} developers currently explore and 
...
\par For how far tools have evolved to aid developers in the act of 
\emph{writing} code, making the act of \emph{understanding} code easier for 
developers appears to be far more challenging. However, it is not an impossible 
task.

\endinput

% TODO: make actual chapters according to the last paragraph.
% TODO: make this less shitty, jesus christ.
